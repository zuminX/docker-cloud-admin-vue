 ...
 * @param loadingName 控制加载的变量名
 */
export const loadingRequest = async(request, object, loadingName = 'loading') => {
  Vue.set(object, loadingName, true)
  try {
    return await request
  } finally {
    Vue.set(object, loadingName, false)
  }
}
